 ...
 */
  ...
  class Install extends \ClicShopping\OM\PagesActionsAbstract {
    ...
    public function execute() {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_Moneris->getDef('alert_module_install_success'), 'success', 'Moneris');
    ...
    private static function installDbMenuAdministration() {
      ...
      $Qcheck = $CLICSHOPPING_Db->get('administrator_menu', 'app_code', ['app_code' => 'app_moneris']);

      if ($Qcheck->fetch() === false) {

        $sql_data_array = ['sort_order' => 4,
                           'link' => 'index.php?A&Payment\Moneris&Configure',
                           'image' => 'modules_payment.gif',
                           'b2b_menu' => 0,
                           'access' => 1,
                           'app_code' => 'app_payment_moneris'
                          ];
