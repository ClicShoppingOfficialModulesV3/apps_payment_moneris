 ...
 */
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract {
    ...
    private static function removeMenu() {
      ...
      $Qcheck = $CLICSHOPPING_Db->get('administrator_menu', 'app_code', ['app_code' => 'app_payment_moneris']);
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code',  'app_payment_moneris');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_payment_moneris']);
      }
    }
  }